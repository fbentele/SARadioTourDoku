...
Die Nutzung von ORMLite zur Objektrelationalen Abbildung von Instanzen in die SQLite Datenbank impliziert, dass das Datenbankschema der Klassenstruktur wie in \ref{fig:domain} abgebildet entspricht. 
